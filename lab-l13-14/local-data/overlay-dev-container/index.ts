...
import tm_tm_uhrp from '/app/src/mod.ts'
import lsf_ls_uhrp from '/app/src/mod.ts'
...
const main = async () => {
    ...
    server.configureTopicManager('tm_uhrp', new tm_tm_uhrp())
    server.configureLookupServiceWithMongo('ls_uhrp', lsf_ls_uhrp)
